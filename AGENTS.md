...
Django demo app for Deepgram Live Text-to-Speech.
...
```
feat(django-live-text-to-speech): add diarization support
fix(django-live-text-to-speech): resolve WebSocket close handling
refactor(django-live-text-to-speech): simplify session endpoint
